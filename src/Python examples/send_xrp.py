...
class TWaXLFrame(wx.Frame):
    ...
    def build_ui(self):
        ...
        self.tx_list.AppendTextColumn("Identifying Hash (Tx#)", mode=dv.DATAVIEW_CELL_EDITABLE)
        self.tx_list.AppendTextColumn("Raw JSON", mode=dv.DATAVIEW_CELL_EDITABLE)
    ...
    def prompt_for_account(self):
        ...
        account_dialog = wx.TextEntryDialog(self,
                ...
                value="sEdVsHGvgKtVGX3ntj2CggKg44HewEM")
    ...
    def add_tx_from_subscription(self, t):
        """
        ...
        ## TODO Azhar
        txSeq = t["tx"]["Sequence"]
        print (f"\nLastLedger: {t['tx']['LastLedgerSequence']} , TxSeq#: {txSeq}, status: {t['engine_result']}, " \
                f"TAG: {t['tx']['DestinationTag']}, TxHash: {t['tx']['hash']}\n")
